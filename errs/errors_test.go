...
func ExampleError() {
	...
	//     [github.com/ddkwork/toolbox/errs_test.ExampleError.func1] errors_test.go:27
	//     [github.com/ddkwork/toolbox/errs_test.ExampleError] errors_test.go:28
...
func TestFormat(t *testing.T) {
	...
	check.Contains(t, result, "[github.com/ddkwork/toolbox/errs_test.TestFormat]")
