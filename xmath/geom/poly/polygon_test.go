...
func TestContains(t *testing.T) {
	...
	containsTests := []containsCase{
		{point: point{X: 199, Y: 20}, contains: false},
		{point: point{X: 200, Y: 20}, contains: true},
		{point: point{X: 300, Y: 120}, contains: true},
		{point: point{X: 250, Y: 50}, contains: true},
		{point: point{X: 260, Y: 60}, contains: true},
		{point: point{X: 290, Y: 110}, contains: true},
		{point: point{X: 319, Y: 139}, contains: true},
		{point: point{X: 321, Y: 140}, contains: false},
		{point: point{X: 320, Y: 141}, contains: false},
	}
	for i, test := range containsTests {
		check.Equal(t, test.contains, p.Contains(test.point), "contains case #%d", i)
	}
	containsEvenOddTests := []containsCase{
		{point: point{X: 199, Y: 20}, contains: false},
		{point: point{X: 200, Y: 20}, contains: true},
		{point: point{X: 300, Y: 120}, contains: true},
		{point: point{X: 250, Y: 50}, contains: false},
		{point: point{X: 260, Y: 60}, contains: true},
		{point: point{X: 290, Y: 110}, contains: false},
		{point: point{X: 319, Y: 139}, contains: true},
		{point: point{X: 321, Y: 140}, contains: false},
		{point: point{X: 320, Y: 141}, contains: false},
	}
	for i, test := range containsEvenOddTests {
		check.Equal(t, test.contains, p.ContainsEvenOdd(test.point), "contains even/odd case #%d", i)
	}
}
	...
	tests := []testCase{
		{
			...
			expected: polygon{{{3, 2}, {3, 1}, {1, 1}, {1, 2}, {1, 3}, {3, 3}}},
		},
		{
			name:     "union #2",
			subject:  polygon{{{2, 1}, {1, 2}, {2, 2}}},
			clipping: polygon{{{1, 2}, {2, 2}, {2, 3}, {1, 2}, {2, 2}, {2, 3}}},
			expected: polygon{{{2, 1}, {1, 2}, {2, 2}}},
		},
		{
			name:    "union #3",
		...
		{
			name:     "union #8",
			subject:  polygon{{{160.094495, 200.379924}, {90.094495, 200.379924}, {55.094495, 139.758145}, {90.094495, 79.136367}}},
			clipping: polygon{{{82.846611, 131.518814}, {66.592063, 159.672517}, {90.094495, 200.379924}, {160.094495, 200.379924}}},
			expected: polygon{{{90.094495, 79.136367}, {55.094495, 139.758145}, {90.094495, 200.379924}, {160.094495, 200.379924}}},
		},
		{
			name:     "union #9",
			subject:  polygon{{{70.784326, -7.668842}, {42.500055, -19.384571}, {22.504998, -11.102347}, {14.215784, -7.668842}, {2.500055, 20.615429}, {4.16327, 24.630785}, {-16.38653, 33.14279}, {-28.102259, 61.427062}}},
			clipping: polygon{{{22.504998, -11.102347}, {14.215784, -7.668842}, {2.500055, 20.615429}, {4.16327, 24.630785}, {-16.38653, 33.14279}, {-18.453791, 38.1336}, {-23.270337, 26.505431}, {16.729663, -13.494569}, {45.013935, -1.778841}, {22.504998, -11.102347}}},
			expected: polygon{{{70.784326, -7.668842}, {42.500055, -19.384571}, {22.504998, -11.102347}, {16.729663, -13.494569}, {-23.270337, 26.505431}, {-18.453791, 38.1336}, {-28.102259, 61.427062}}},
		},
		{
			name:     "union #10",
			subject:  rect3,
			clipping: circle,
			expected: polygon{{{36, 7}, {24, 7}, {23.163772, 7.043825}, {22.336706, 7.174819}, {21.527864, 7.391548}, {20.746107, 7.691636}, {20, 8.071797}, {19.297718, 8.527864}, {18.646955, 9.054841}, {18.054841, 9.646955}, {17.527864, 10.297718}, {17.071797, 11}, {16.691636, 11.746107}, {16.391548, 12.527864}, {16.174819, 13.336706}, {16.043825, 14.163772}, {16, 15}, {16.043825, 15.836228}, {16.174819, 16.663294}, {16.391548, 17.472136}, {16.691636, 18.253893}, {17.071797, 19}, {17.527864, 19.702282}, {18.054841, 20.353045}, {18.646955, 20.945159}, {19.297718, 21.472136}, {20, 21.928203}, {20.746107, 22.308364}, {21.527864, 22.608452}, {22.336706, 22.825181}, {23.163772, 22.956175}, {24, 23}, {36, 23}}},
		},
		{
			name:     "union #11",
			subject:  polygon1,
			clipping: polygon2,
			expected: polygon{{{90.094495, 79.136368}, {55.094495, 139.758146}, {66.592063, 159.672518}, {66.592063, 159.672518}, {90.094495, 200.379924}, {160.094495, 200.379924}}},
		},
		{
			name:     "union #12",
			subject:  polygon3,
			clipping: polygon4,
			expected: polygon{{{82.500055, 20.615429}, {42.500055, -19.384571}, {2.500055, 20.615429}, {7.604714, 25.720088}, {7.604714, 25.720088}, {32.55986, 50.675234}, {42.500055, 60.615429}}},
		},
		{
			name:     "union overlapping segments #1",
			subject:  polygon{{{0, 0}, {10, 0}, {0, 10}}},
			clipping: polygon{{{6, 5}, {6, 4}, {5, 5}}},
			expected: polygon{{{5, 5}, {6, 5}, {6, 4}, {10, 0}, {0, 0}, {0, 10}}},
		},
		{
			name:     "union overlapping segments #2",
			subject:  polygon{{{0, 0}, {10, 0}, {0, 10}}},
			clipping: polygon{{{6, 4}, {4, 5}, {5, 5}}},
			expected: polygon{{{5, 5}, {6, 4}, {10, 0}, {0, 0}, {0, 10}}},
		},
		{
			name:     "union overlapping segments #3",
			subject:  polygon{{{0, 10}, {10, 10}, {0, 0}}},
			clipping: polygon{{{6, 5}, {6, 6}, {5, 5}}},
			expected: polygon{{{6, 6}, {6, 5}, {5, 5}, {0, 0}, {0, 10}, {10, 10}}},
		},
		{
			name:     "union overlapping segments #4",
			subject:  polygon{{{0, 10}, {10, 10}, {0, 0}}},
			clipping: polygon{{{5, 5}, {5, 6}, {6, 6}}},
			expected: polygon{{{6, 6}, {5, 5}, {0, 0}, {0, 10}, {10, 10}}},
		},
		{
			...
			expected: polygon{{{40143, 8369}, {40131, 8372}, {40127, 8374}, {40128, 8373}, {40106, 8376}, {40124.918919, 8375.054054}, {40122, 8377}}},
		},
		{
		...
		},
		{
			...
			subject:  selfIntersectingRects,
			clipping: rect2,
			expected: polygon{{{2, 0.75}, {3, 0.75}, {3, 0.25}, {2, 0.25}, {2, 0}, {0, 0}, {0, 0.25}, {0, 0.75}, {0, 1}, {2, 1}}},
		},
	}
	for i, test := range tests {
		// We check the against the string version to avoid needing to specify more than 6 digits of precision
		check.Equal(t, test.expected.String(), test.subject.Union(test.clipping).String(), "test case %d (%s)", i, test.name)
	}
}
...
func TestIntersect(t *testing.T) {
	tests := []testCase{
		...
		{
			name:     "intersect #2",
			subject:  polygon{{{131.595971, 287.938524}, {100, 273.205081}, {71.442478, 253.208889}, {71.442478, -53.208889}, {100, -73.205081}, {131.595971, -87.938524}}},
			clipping: polygon{{{128.557522, -53.208889}, {100, -73.205081}, {100, -73.205081}, {71.442478, -53.208889}, {71.442478, 253.208889}, {100, 273.205081}, {128.557522, 253.208889}}},
			expected: polygon{{{128.557522, 253.208889}, {128.557522, -53.208889}, {100, -73.205081}, {71.442478, -53.208889}, {71.442478, 253.208889}, {100, 273.205081}}},
		},
		{
			name:     "intersect #3",
			subject:  polygon{{{100, 100}, {98.480775, 117.364818}, {98.480775, 82.635182}}},
			clipping: polygon{{{100, 100}, {100, 99.999999}, {100, 100}, {100, 100.000001}, {100, 100}}},
			expected: polygon{},
		},
		{
			name:     "intersect #4",
			subject:  polygon{{{100, 100}, {98.480775, 117.364818}, {98.480775, 82.635182}}},
			clipping: polygon{{{100, 100}, {100, 100}, {100, 100}, {100, 100}, {100, 100}}},
			expected: polygon{},
		},
		{
			name:     "intersect #5",
			subject:  polygon3,
			clipping: polygon{{{7.604714, 25.720088}, {11.897741, 21.427062}, {36.852887, 46.382207}, {32.55986, 50.675234}}},
			expected: polygon{{{36.852887, 46.382207}, {11.897741, 21.427062}, {7.604714, 25.720088}, {32.55986, 50.675234}}},
		},
		{
			name:     "intersect #6",
			subject:  polygon{{{300, -100}, {259.807621, 50}, {-259.807621, 50}, {-300, -100}}},
			clipping: polygon{{{273.205081, 0}, {259.807621, -50}, {-259.807621, -50}, {-273.205081, -0}, {-259.807621, 50}, {259.807621, 50}}},
			expected: polygon{{{273.205081, -0.000001}, {259.807621, -50}, {-259.807621, -50}, {-273.205081, -0.000001}, {-259.807621, 50}, {259.807621, 50}}},
		},
		{
			name:     "intersect #7",
			subject:  polygon{{{300, -100}, {277.16386, 14.80503}, {-277.16386, 14.80503}, {-300, -100}}},
			clipping: polygon{{{280.108763, 0}, {277.16386, -14.80503}, {-277.16386, -14.80503}, {-280.108763, -0}, {-277.16386, 14.80503}, {277.16386, 14.80503}, {280.108763, 0}}},
			expected: polygon{{{280.108763, 0}, {277.16386, -14.80503}, {-277.16386, -14.80503}, {-280.108763, -0}, {-277.16386, 14.80503}, {277.16386, 14.80503}}},
		},
		{
			name:     "intersect #8",
			subject:  polygon{{{-196.961551, 65.270364}, {-187.938524, 31.595971}, {-173.205081, 0}, {-153.208889, -28.557522}, {153.208889, -28.557522}, {173.205081, -0}, {187.938524, 31.595971}, {196.961551, 65.270364}}},
			clipping: polygon{{{196.961551, -65.270364}, {187.938524, -31.595971}, {173.205081, -0}, {153.208889, 28.557522}, {-153.208889, 28.557522}, {-173.205081, -0}, {-187.938524, -31.595971}, {-196.961551, -65.270364}}},
			expected: polygon{{{173.205081, 0}, {153.208889, -28.557522}, {-153.208889, -28.557522}, {-173.205081, 0}, {-153.208889, 28.557522}, {153.208889, 28.557522}}},
		},
		{
			name:     "intersect #9",
			subject:  polygon{{{128.557522, 253.208889}, {100, 273.205081}, {68.404029, 287.938524}, {68.404029, -87.938524}, {100, -73.205081}, {128.557522, -53.208889}}},
			clipping: polygon{{{131.595971, 287.938524}, {100, 273.205081}, {71.442478, 253.208889}, {71.442478, -53.208889}, {100, -73.205081}, {131.595971, -87.938524}}},
			expected: polygon{{{100, 273.205081}, {128.557522, 253.208889}, {128.557522, -53.208889}, {100, -73.205081}, {71.442478, -53.208889}, {71.442478, 253.208889}, {100, 273.205081}}},
		},
		{
			name:     "intersect #10",
			subject:  rect3,
			clipping: circle,
			expected: polygon{{{24.836228, 22.956175}, {25.663294, 22.825181}, {26.472136, 22.608452}, {27.253893, 22.308364}, {28, 21.928203}, {28.702282, 21.472136}, {29.353045, 20.945159}, {29.945159, 20.353045}, {30.472136, 19.702282}, {30.928203, 19}, {31.308364, 18.253893}, {31.608452, 17.472136}, {31.825181, 16.663294}, {31.956175, 15.836228}, {32, 15}, {31.956175, 14.163772}, {31.825181, 13.336706}, {31.608452, 12.527864}, {31.308364, 11.746107}, {30.928203, 11}, {30.472136, 10.297718}, {29.945159, 9.646955}, {29.353045, 9.054841}, {28.702282, 8.527864}, {28, 8.071797}, {27.253893, 7.691636}, {26.472136, 7.391548}, {25.663294, 7.174819}, {24.836228, 7.043825}, {24, 7}, {24, 23}}},
		},
		{
			name:     "intersect #11",
		...
		{
			name:     "intersect #13",
			subject:  polygon{{{0, 10}, {0, 0}, {10, 0}, {10, 10}}},
			clipping: polygon{{{0, 5}, {5, 0}, {10, 5}, {5, 10}}},
			expected: polygon{{{10, 5}, {5, 0}, {0, 5}, {5, 10}}},
		},
		{
			name:     "intersect self-intersection",
			subject:  selfIntersectingRects,
			clipping: rect2,
			expected: polygon{{{2, 0.25}, {0, 0.25}, {0, 0.75}, {2, 0.75}}},
		},
	}
	for i, test := range tests {
		// We check the against the string version to avoid needing to specify more than 6 digits of precision
		check.Equal(t, test.expected.String(), test.subject.Intersect(test.clipping).String(), "test case %d (%s)", i, test.name)
	}
}
...
func TestSubtract(t *testing.T) {
	tests := []testCase{
		{
			...
			subject:  polygon1,
			clipping: polygon2,
			expected: polygon{{{90.094495, 79.136368}, {55.094495, 139.758146}, {66.592063, 159.672518}, {82.846611, 131.518814}, {160.094495, 200.379924}}},
		},
		{
			name:     "subtract #2",
			subject:  polygon3,
			clipping: polygon4,
			expected: polygon{{{82.500055, 20.615429}, {42.500055, -19.384571}, {2.500055, 20.615429}, {7.604714, 25.720088}, {11.897741, 21.427062}, {36.852887, 46.382207}, {32.55986, 50.675234}, {42.500055, 60.615429}}},
		},
		{
			name:     "subtract #3",
			subject:  polygon{{{38.572124, 172.339556}, {40, 171.339746}, {41.579799, 170.603074}, {43.263518, 170.151922}, {45, 170}, {46.736482, 170.151922}, {48.420201, 170.603074}, {50, 171.339746}, {51.427876, 172.339556}}},
			clipping: polygon{{{51.427876, 172.339556}, {50, 171.339746}, {48.420201, 170.603074}, {46.736482, 170.151922}, {45, 170}, {43.263518, 170.151922}, {42.781168, 170.281168}, {42.651922, 170.763518}, {42.5, 172}}},
			expected: polygon{{{42.5, 172}, {42.651922, 170.763518}, {42.781168, 170.281168}, {43.263518, 170.151922}, {41.579799, 170.603074}, {40, 171.339746}, {38.572124, 172.339556}, {51.427876, 172.339556}}},
		},
		{
			name:     "subtract #4",
			subject:  rect3,
			clipping: circle,
			expected: polygon{{{36, 7}, {24, 7}, {24.836228, 7.043825}, {25.663294, 7.174819}, {26.472136, 7.391548}, {27.253893, 7.691636}, {28, 8.071797}, {28.702282, 8.527864}, {29.353045, 9.054841}, {29.945159, 9.646955}, {30.472136, 10.297718}, {30.928203, 11}, {31.308364, 11.746107}, {31.608452, 12.527864}, {31.825181, 13.336706}, {31.956175, 14.163772}, {32, 15}, {31.956175, 15.836228}, {31.825181, 16.663294}, {31.608452, 17.472136}, {31.308364, 18.253893}, {30.928203, 19}, {30.472136, 19.702282}, {29.945159, 20.353045}, {29.353045, 20.945159}, {28.702282, 21.472136}, {28, 21.928203}, {27.253893, 22.308364}, {26.472136, 22.608452}, {25.663294, 22.825181}, {24.836228, 22.956175}, {24, 23}, {36, 23}}},
		},
		{
			name:     "subtract #5",
		...
		{
			name:     "subtract #6",
			subject:  polygon{{{426694.636527, -668547.161158}, {426714.57523, -668548.923865}, {426745.396481, -668550.465125}}},
			clipping: polygon{{{426714.57523, -668548.923865}, {426744.637187, -668550.05919}, {426745.396482, -668550.465224}}},
			expected: polygon{
	...
	for i, test := range tests {
		// We check the against the string version to avoid needing to specify more than 6 digits of precision
		check.Equal(t, test.expected.String(), test.subject.Subtract(test.clipping).String(), "test case %d (%s)", i, test.name)
	}
}
...
func TestXor(t *testing.T) {
	...
	for i, test := range tests {
		// We check the against the string version to avoid needing to specify more than 6 digits of precision
		check.Equal(t, test.expected.String(), test.subject.Xor(test.clipping).String(), "test case %d (%s)", i, test.name)
	}
}
